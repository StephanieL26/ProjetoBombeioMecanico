...
$classe = $_POST['classe']; $diametrocoluna = $_POST['diametrocoluna']; $corrosividade = $_POST['corrosividade']; $cursomaximo = $_POST['cursomaximo']; 
$otimizar = $_POST['otimizar'];
...
$cargamaxima = 0; $cargaminima = 0; $F1Skr = 0; $F2Skr = 0; $F3Skr = 0; $TSKr = 0; $Ta = 0; $tensaomaxima = 0; $tensaominima = 0; $tensaoadmissivel = 0; $potencia = 0; $torque = 0;
			/*AQUI*/
			if($api == '44'){	
				$diam = array(1, 1.0625, 1.25, 1.5,	1.75, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.75, 4.75);
				if($diametro == '1'){	
					$diametro1 = 1; 
					$peso = 0.726; 
			...
			/*AQUI*/
				...
				$diam = array(1.0625, 1.25, 1.5, 1.75, 2, 2.25, 2.5);
				if($diametro == '1 1/16'){	
					$diametro1 = 1.0625; 
					$peso = 0.908; 
    ...
    <footer class='bg-light py-5'>
		...
		break;}
			...
			/*AQUI*/
				...
				$diam = array(1.0625, 1.25, 1.5, 1.75);
				if($diametro == '1 1/16'){	
					$diametro1 = 1.0625; 
					$peso = 1.164; 
    ...
    <footer class='bg-light py-5'>
		...
		break;}
			...
			/*AQUI*/
				...
				$diam = array(1.0625, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75);
				if($diametro == '1 1/16'){	
					$diametro1 = 1.0625; 
					$peso = 1.307; 
    ...
    <footer class='bg-light py-5'>
		...
		/*AQUI*/
				...
				$diam = array(1.0625, 1.25, 1.5, 1.75, 2, 2.25);
				if($diametro == '1 1/16'){	
					$diametro1 = 1.0625; 
					$peso = 1.566; 
    ...
    <footer class='bg-light py-5'>
		...
		/*AQUI*/
				...
				$diam = array(1.0625, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3.75);
				if($diametro == '1 1/16'){	
					$diametro1 = 1.0625; 
					$peso = 1.802; 
    ...
    <footer class='bg-light py-5'>
		...
		/*AQUI*/
				...
				if($diametro == '1 1/16'){	
					$diametro1 = 1.0625; 
					$peso = 1.883; 
					$constante_elastica = 0.8873*0.000001; 
					$fator_frequencia = 1.261;} 
				else if($diametro == '1 1/4'){	
					$diametro1 = 1.25; 
					$peso = 1.943; 
					$constante_elastica = 0.841*0.000001; 
					$fator_frequencia = 1.253;} 
				else if($diametro == '1 1/2'){	
					$diametro1 = 1.5; 
					$peso = 2.039; 
					$constante_elastica = 0.791*0.000001; 
					$fator_frequencia = 1.232;} 
				else if($diametro == '1 3/4'){	
					$diametro1 = 1.75; 
					$peso = 2.138; 
					$constante_elastica = 0.738*0.000001; 
					$fator_frequencia = 1.201;} 
				else{
					echo "
	<html lang='pt-br, en'>
		<head>
    ...
    <footer class='bg-light py-5'>
		...
		/*AQUI*/
				...
				$diam = array(1.0625, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3.25, 3.75, 4.75);
				if($diametro == '1 1/16'){	
					$diametro1 = 1.0625; 
					$peso = 2.39; 
    ...
    <footer class='bg-light py-5'>
		...
		/*AQUI*/
				...
				$diam = array(1.0625, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3.25);
				if($diametro == '1 1/16'){	
					$diametro1 = 1.0625; 
					$peso = 2.645; 
    ...
    <footer class='bg-light py-5'>
		...
		/*AQUI*/
				...
				$diam = array(1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3.25, 3.75, 4.75);
				if($diametro == '1 1/4'){	
					$diametro1 = 1.25; 
					$peso = 3.076; 
    ...
    <footer class='bg-light py-5'>
		...
		/*AQUI*/
				...
				$diam = array(1.5, 1.75, 2, 2.25, 2.5, 2.75);
				if($diametro == '1 1/2'){	
					$diametro1 = 1.5; 
					$peso = 3.085; 
    ...
    <footer class='bg-light py-5'>
		...
		/*AQUI*/
				...
				$diam = array(1.5,	1.75, 2, 2.25, 2.5, 2.75, 3.25, 3.75);
				if($diametro == '1 1/2'){	
					$diametro1 = 1.5; 
					$peso = 3.376; 
    ...
    <footer class='bg-light py-5'>
		...
		/*AQUI*/
				...
				$diam = array(1.5,	1.75, 2, 2.25, 2.5, 2.75, 3.25, 3.75, 4.75);
				if($diametro == '1 1/2'){	
					$diametro1 = 1.5; 
					$peso = 3.855; 
    ...
    <footer class='bg-light py-5'>
		...
		break;}
			...
			if($otimizar == 'Curso'){
				$menorc = 999999999999;
				$menor_d = 0;
				$cursoefetivoancotim = 0;
				$eficienciaotim = 0;
				
				if ($cursomaximo == '64'){
					for ($c = 1; $c <=64; $c++){	
					
						$cursoefetivoancotim = $c * 0.89;

						$vazaobombaancotim = 0.1166 * ($diametro1*$diametro1) * $cursoefetivoancotim * $velocidade;
						$vazaobombaancotim = number_format($vazaobombaancotim, 2, '.', '');

						$eficienciavolumetricaancotimicur = ( 283 / $vazaobombaancotim) * 100;
						$eficienciavolumetricaancotimicur = number_format($eficienciavolumetricaancotimicur, 2, '.', '');

							if(($eficienciavolumetricaancotimicur >= 1) and ($eficienciavolumetricaancotimicur <= 100)){
								if($cursoefetivoancotim < $menorc){
								   $eficienciaotim = $eficienciavolumetricaancotimicur;
								   $menorc = $cursoefetivoancotim;
								   $menorc = number_format($menorc, 2, '.', '');
								   $menor_d = $c;
								}
							}
						}
				}
				elseif ($cursomaximo == '74'){
					for ($c = 1; $c <=74; $c++){	
			...
			if($otimizar == 'Curso'){
				$menorn = 999999999999;
				$menor_d = 0;
				$cursoefetivoancotimnanc = 0;
				$eficienciaotimnanc = 0;
				
				if ($cursomaximo == '64'){
					for ($c = 1; $c <=64; $c++){	
					
						$cursoefetivoancotimnanc = (($c * 0.89) - ($cargafluido/$constante_coluna));

						$vazaobombaancotim = 0.1166 * ($diametro1*$diametro1) * $cursoefetivoancotimnanc * $velocidade;
						$vazaobombaancotim = number_format($vazaobombaancotim, 2, '.', '');
						...
						$eficienciavolumetricaancotimicur = number_format($eficienciavolumetricaancotimicur, 2, '.', '');
							...
							if(($eficienciavolumetricaancotimicur >= 1) and ($eficienciavolumetricaancotimicur <= 100)){
								if($cursoefetivoancotimnanc < $menorn){
								   $eficienciaotimnanc = $eficienciavolumetricaancotimicur;
								   $menorn = $cursoefetivoancotimnanc;
								   $menorn = number_format($menorn, 2, '.', '');
								   $menor_d = $c;
								}
							}
						}
				...
				//OtimizaçãoVelocidade
				 
			if($otimizar == 'Velocidade'){
				$menor = 999999999999;
				$menor_d = 0;
				$vazaobombaancotimizada = 0;
				$eficienciaotim = 0;
				
				for ($v = 5; $v <=20; $v++)
				{
				   $vazaobombaancotimizada = 0.1166 * ($diametro1*$diametro1) * $cursoefetivoanc * $v ;
				  
				   $eficienciavolumetricaancotimi = ($vazaosuperficie / $vazaobombaancotimizada) * 100;
				   $eficienciavolumetricaancotimi = number_format($eficienciavolumetricaancotimi, 2, '.', '');
				   
					if(($eficienciavolumetricaancotimi >= 1) and ($eficienciavolumetricaancotimi <= 100)){
					   if($vazaobombaancotimizada < $menor){
						   $eficienciaotim = $eficienciavolumetricaancotimi;
						   $menor = $vazaobombaancotimizada;
						   $menor = number_format($menor, 2, '.', '');
						   $menor_d = $v;
						}
					}
			...
			if($otimizar == 'Velocidade'){
				$menorn = 999999999999;
				$menor_d = 0;
				$vazaobombanancotimizada = 0;
				$eficienciaotimnanc = 0;
				
				for ($v = 5; $v <=20; $v++)
				{
				   $vazaobombanancotimizada = 0.1166 * ($diametro1*$diametro1) * $cursoefetivonanc * $v ;
				  
				   $eficienciavolumetricaancotimi = ( $vazaosuperficie / $vazaobombanancotimizada) * 100;
				   $eficienciavolumetricaancotimi = number_format($eficienciavolumetricaancotimi, 2, '.', '');
				   
					if(($eficienciavolumetricaancotimi >= 1) and ($eficienciavolumetricaancotimi <= 100)){
					   if($vazaobombanancotimizada < $menorn){
						   $eficienciaotimnanc = $eficienciavolumetricaancotimi;
						   $menorn = $vazaobombanancotimizada;
						   $menorn = number_format($menorn, 2, '.', '');
						   $menor_d = $v;
						}
					}
			...
			//OtimizaçãoDiam
			if($otimizar == 'Diâmetro'){
				$menord = 999999999999;
				$menor_d = 0;
				$eficienciaotim = 0;

				for ( $i = 0; $i < count( $diam ); $i++ ) {
					
					$diametrootimi = $diam[$i];
					
					$vazaobombaancdiam = 0.1166 * ($diametrootimi*$diametrootimi) * $cursoefetivoanc * $velocidade;
					
					$eficienciavolumetricaancotimidiam = ($vazaosuperficie / $vazaobombaancdiam) * 100;
					$eficienciavolumetricaancotimidiam = number_format($eficienciavolumetricaancotimidiam, 2, '.', '');
					
					if(($eficienciavolumetricaancotimidiam >= 1) and ($eficienciavolumetricaancotimidiam <= 100)){
							if($diametrootimi < $menord){
							   $eficienciaotim = $eficienciavolumetricaancotimidiam;
							   $menord = $diametrootimi;
							   $menord = number_format($menord, 2, '.', '');
							   $menor_d = $diam[$i];
							}
						}
			...
			if($otimizar == 'Diâmetro'){
				...
				for ( $i = 0; $i < count( $diam ); $i++ ) {
					...
					$vazaobombanancdiam = 0.1166 * ($diametrootimi*$diametrootimi) * $cursoefetivonanc * $velocidade;
					
					$eficienciavolumetricaancotimidiam = ($vazaosuperficie / $vazaobombanancdiam) * 100;
					$eficienciavolumetricaancotimidiam = number_format($eficienciavolumetricaancotimidiam, 2, '.', '');
					
					if(($eficienciavolumetricaancotimidiam >= 1) and ($eficienciavolumetricaancotimidiam <= 100)){
							if($diametrootimi < $menorn){
							   $eficienciaotimnanc = $eficienciavolumetricaancotimidiam;
							   $menorn = $diametrootimi;
							   $menorn = number_format($menorn, 2, '.', '');
							   $menor_d = $diam[$i];
							}
						}
		...
		<div class='container'>
			<div id='div3' class='row text-center'>
				...
				<div class='col-lg-3 col-md-6 text-center'>
					<div class='mt-5'>
						<p style='color:black; font-size: 30px;'> Otimização: </h2>
					</div>
				</div>";
							if($otimizar == "Diâmetro"){
									echo"
									<div class='col-lg-9 col-md-6 text-center'>
										<div class='mt-5'>
											<p style='color:black; font-size: 20px;'> Diâmetro utilizado: </h2> $menor_d";
							}
							elseif($otimizar == "Velocidade"){
									echo"
									<div class='col-lg-9 col-md-6 text-center'>
										<div class='mt-5'>
											<p style='color:black; font-size: 20px;'> Velocidade utilizada: </h2> $menor_d";
							}
							elseif($otimizar == "Curso"){
									echo"
									<div class='col-lg-9 col-md-6 text-center'>
										<div class='mt-5'>
											<p style='color:black; font-size: 20px;'> Curso utilizado: </h2> $menor_d";
								}
						if($eficienciavolumetricaanc == $eficienciaotim){
							echo "<p style='color:black; font-size: 20px;'>A eficiência calculada já é a eficiência máxima do sistema </p>";
							echo "<p style='color:black; font-size: 20px;'>Eficiência Volumétrica Ancorada: $eficienciavolumetricaanc %  </h2>
							</div>
							</div>";
						}
						else {
							echo "<p style='color:black; font-size: 20px;'> Eficiência Volumétrica Máxima: </h2>  $eficienciaotim % 
							</div>
							</div>";
						};
						echo"
						...
						";
						if($eficienciavolumetricaanc >= 100){
							echo "<p style='color:black; font-size: 20px;'>Eficiência Volumétrica ultrapassa 100%! Por favor, digite novamente os dados ou faça a otimização";
						}
						echo"
				...
				<div class='col-lg-3 col-md-12 text-center'>
					<div class='mt-5'>
						<p style='color:black; font-size: 30px;'> Otimização: </h2>
							...
							if($eficienciavolumetricananc == $eficienciaotimnanc){
							echo "<p style='color:black; font-size: 20px;'>A eficiência calculada já é a eficiência máxima do sistema </p>";
							echo "<p style='color:black; font-size: 20px;'>Eficiência Volumétrica Ancorada: $eficienciavolumetricananc %  </h2>
							</div>
							</div>";
						}
						else {
							echo "<p style='color:black; font-size: 20px;'> Eficiência Volumétrica Máxima: </h2>  $eficienciaotimnanc %
							</div>
							</div>";
						}
						echo"
						...
						";
						if($eficienciavolumetricananc >= 100){
							echo "<p style='color:black; font-size: 20px;'>Eficiência Volumétrica ultrapassa 100%! Por favor, digite novamente os dados ou faça a otimização<p>";
						};
						echo"
